...
const Perkslables = ({selected,onChange}) => {
  ...
  return (
    <div>
       <div className='grid grid-cols-2 gap-1 md:grid-cols-4 lg:grid-cols-6'>
                                ...
                                <label>
                                    <input type='checkbox'onChange={handleclick} name="wparking" />
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                ...
                                <label>
                                    <input type='checkbox'onChange={handleclick} name="pets" />
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
